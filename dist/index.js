...
var ReactGodot = function (props) {
    var script = props.script, pck = props.pck, wasm = props.wasm, _a = props.resize, resize = _a === void 0 ? false : _a, width = props.width, height = props.height, config = props.config;
    ...
    return (React.createElement("div", { id: "wrap", ref: outerRef },
        React.createElement(AsyncLoading, null, engine && (React.createElement(ReactCanvas, { pck: pck, engine: engine, wasm: wasm, width: dimensions[0], height: dimensions[1], config: config })))));
};
